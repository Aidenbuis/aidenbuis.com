...
In this deep dive we will learn how Git works behind the curtain. We will look into how Git keeps track of changes. The aim is that we finish with a concise mental model.

Let's start with the command to give birth to a new repository: `git init`.
